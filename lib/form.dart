...
import 'package:pbp_lab_flutter/main.dart';
...
class _MyFormPageState extends State<MyFormPage> {
  ...
  String cekJenjang(bool jenjang, String namaJenjang) {
    if (jenjang==true)
      if (namaJenjang=="sarjana")
        return "Sarjana";
      else if (namaJenjang=="diploma")
        return "Diploma";
      else if (namaJenjang=="magister")
        return "Magister";
      else if (namaJenjang=="doktor")
        return "Doktor";
    return "";
  }
                              ...
                              child: ListView(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    ...
                                    "\nJenjang: " + cekJenjang(jenjangSarjana, "sarjana")+
                                    cekJenjang(jenjangDiploma, "diploma") +
                                    cekJenjang(jenjangMagister, "magister") +
                                    cekJenjang(jenjangDoktor, "doktor") + "\nUmur: " +
                                    umur.round().toString() + "\nKelas: " + kelasPBP,
